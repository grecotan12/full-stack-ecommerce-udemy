...
public class MyDataRestConfig implements RepositoryRestConfigurer{
    ...
    private void exposeIds(RepositoryRestConfiguration config) {
        ...
        // - expose the entity ide for the array of entity/domains types
        Class[] doomainTypes = entityClasses.toArray(new Class[0]);
        config.exposeIdsFor(doomainTypes);
    }
}
